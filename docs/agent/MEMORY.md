...
- Los perfiles de fermentación se pueden iniciar, pausar y reanudar; un planificador avanza fases por tiempo, actualiza el setpoint y registra eventos. Al cerrar el lote, el control del tanque vuelve a `OFF`.
- La bitácora de fermentación acepta notas, mediciones, muestras, desviaciones, controles de calidad, sanitización y adiciones estructuradas. Las alarmas conservan historial y reconocimiento con operador, hora y nota. Faltan rampas térmicas y firma ligada a autenticación.
